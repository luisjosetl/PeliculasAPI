...
namespace PeliculasAPI
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        {
            var rolAdminId = "e6708656-4376-4933-abba-15d9062c1adf";
            var usuarioAdminId = "9fa70639-8caf-4397-9074-248adf820bed";
            ...
            var usuarioAdmin = new IdentityUser()
            {
                ...
                PasswordHash = passwordHasher.HashPassword(null, "luis123!")
            };
            ...
            modelBuilder.Entity<SalaDeCine>()
               .HasData(new List<SalaDeCine>
               {
                    ...
                    new SalaDeCine{Id = 4, Nombre = "Sambil USA", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.9118804, 18.4826214))},
