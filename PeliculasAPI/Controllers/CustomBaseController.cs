...
namespace PeliculasAPI.Controllers
{
    ...
    public class CustomBaseController : ControllerBase
    {
        ...
        {
            var entidad = await context.Set<TEntidad>().AsNoTracking().FirstOrDefaultAsync(x => x.Id.Equals(id));
        ...
        {
            var existe = await context.Set<TEntidad>().AnyAsync(x => x.Id.Equals(id));
            ...
            where TEntidad: class,IId
        {
            ...
            var entidadDB = context.Set<TEntidad>().FirstOrDefaultAsync(x => x.Id.Equals(id));
            ...
            if (!TryValidateModel(entidadDTO))
        ...
        protected async Task<List<TDTO>> Get<TEntidad, TDTO>(PaginacionDTO paginacionDTO,
            ...
            where TEntidad : class
        {
            await HttpContext.InsertarparametrosPaginacion(queryable, paginacionDTO.CatidadRegistrosPorPagina);
